...
public class RestClient {
	...
	public static void fetchPatientList() throws IOException, InterruptedException {
		...
		var request = HttpRequest.newBuilder().uri(URI.create(apiEndPoint)).header("Content-Type", "application-json").GET().build();
	...
	public static void fetchPatientById(Integer patientId) throws IOException, InterruptedException {
	...
	public static HttpResponse<String> createPatient(Patient patient) throws IOException, InterruptedException {
		...
		var request = HttpRequest.newBuilder()
				...
				//.POST(HttpRequest.BodyPublishers.ofString(new ObjectMapper().writeValueAsString(sampleDataForCreatePatient()))).build();
...
public static void updatePatient(Integer patientId) throws IOException, InterruptedException {
		...
		var request = HttpRequest.newBuilder()
				.uri(URI.create(apiEndPoint))
				.header("Content-Type", "application/json")
				.PUT(HttpRequest.BodyPublishers.ofString(new ObjectMapper().writeValueAsString(sampleDataForUpdatePatient()))).build();
...
public static void removePatient(Integer patientId) throws IOException, InterruptedException {
	...
	private static Patient sampleDataForCreatePatient() {
        ...
        patient.setAddress(Arrays.asList(
                permanentAddress
